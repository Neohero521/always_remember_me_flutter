            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  const Spacer(),
                  Icon(expanded ? Icons.expand_less : Icons.expand_more, color: V4Colors.textSecondary),
                ],
              ),
            ),
          ),
                  ...
                  children: [
                    ...
                    Text(
                      hasGraph ? '有图谱 · 约 ${chapters.firstWhere((c) => c.id.toString() == selectedChapterId, orElse: () => chapters.first).content.length} 字'
                          : '暂无图谱，建议先生成',
                      style: TextStyle(fontSize: 12, color: hasGraph ? V4Colors.success : V4Colors.warning),
                    ),
                  ],
                );
              }),
...
class _GenerationProgressCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      margin: EdgeInsets.zero,
      color: V4Colors.primary.withOpacity(0.05),
      child: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(
          children: [
            Row(
              children: [
                ...
                const Text(
                  '⏳ 正在生成续写内容...',
                  style: TextStyle(fontWeight: FontWeight.bold, color: V4Colors.primary),
                ),
                const Spacer(),
                TextButton(
                  onPressed: onStop,
                  style: TextButton.styleFrom(foregroundColor: V4Colors.error),
                  child: const Text('取消'),
                ),
              ],
            ),
            ...
            LinearProgressIndicator(
              backgroundColor: V4Colors.divider,
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: ElevatedButton.icon(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: V4Colors.success,
                  ...
                  Center(
                    child: TextButton(
                      ...
                      child: const Text(
                        '清除结果',
                        style: TextStyle(color: V4Colors.error, fontSize: 13),
                      ),
                    ),
                  ),
                ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text(
            '─── 质量评估 ───',
            style: TextStyle(fontSize: 12, color: V4Colors.textSecondary, fontWeight: FontWeight.w500),
          ),
          const SizedBox(height: 12),
                    ...
                    Row(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: isPassed
                                ? V4Colors.success.withOpacity(0.2)
                                : V4Colors.error.withOpacity(0.2),
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize: 11,
                              color: isPassed ? V4Colors.success : V4Colors.error,
                              fontWeight: FontWeight.bold,
                            ),
                          ),
                        ),
...
class _PrecheckPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isPass
            ? V4Colors.success.withOpacity(0.08)
            : V4Colors.warning.withOpacity(0.08),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: (isPass ? V4Colors.success : V4Colors.warning).withOpacity(0.2),
        ),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Row(
            children: [
              Icon(
                ...
                size: 16,
                color: isPass ? V4Colors.success : V4Colors.warning,
              ),
              const SizedBox(width: 8),
              Expanded(
                child: Text(
                ...
                children: [
                  ...
                  if (chain.isNotEmpty)
                    TextButton(
                      ...
                      child: const Text(
                        '清空',
                        style: TextStyle(color: V4Colors.error, fontSize: 12),
                      ),
                    ),
                  Icon(expanded ? Icons.expand_less : Icons.expand_more, color: V4Colors.textSecondary),
                ],
...
class _ChainLinearView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: V4Colors.chainBadge.withOpacity(0.05),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: V4Colors.chainBadge.withOpacity(0.15)),
      ),
      child: SingleChildScrollView(
...
class _ChainNode extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
      decoration: BoxDecoration(
        color: isLast ? V4Colors.chainBadge : V4Colors.chainBadge.withOpacity(0.1),
        borderRadius: BorderRadius.circular(20),
        border: Border.all(
          color: V4Colors.chainBadge.withOpacity(0.3),
        ),
      ),
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Text(
            ...
            style: TextStyle(
              fontSize: 11,
              fontWeight: FontWeight.bold,
              color: isLast ? Colors.white : V4Colors.chainBadge,
            ),
          ),
          Text(
            ...
            style: TextStyle(
              fontSize: 9,
              color: isLast ? Colors.white70 : V4Colors.textSecondary,
            ),
          ),
        ],
      ),
...
class _ChainCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
        color: V4Colors.chainBadge.withOpacity(0.06),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: V4Colors.chainBadge.withOpacity(0.15)),
      ),
      child: Column(
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: const Row(children: [
        Icon(Icons.fast_forward, color: V4Colors.accent),
        SizedBox(width: 8),
        Text('批量续写中')
      ]),
      content: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: const TextStyle(fontSize: 13, color: V4Colors.textSecondary),
            ),
            const SizedBox(height: 12),
            Row(
              children: [
                Text(
                  ...
                  style: const TextStyle(fontSize: 13, color: V4Colors.success),
                ),
                const SizedBox(width: 16),
                Text(
                  '❌ 失败: ${widget.state.failed}',
                  style: const TextStyle(fontSize: 13, color: V4Colors.error),
                ),
              ],
            ),
          ],
